...
bool SystemClass::Frame()
{
	...
	if(m_Input->IsMoveForwardPressed() == true) m_Graphics->GetCamera()->MoveForward(0.1f);
	...
	float deltaX = m_Input->GetMouseDeltaX();
	float deltaY = m_Input->GetMouseDeltaY();
...
void SystemClass::InitializeWindows(int& screenWidth, int& screenHeight)
{
	...
	// 프로그램 이름을 지정합니다
	m_applicationName = L"Dx11Demo_20";
