...
float4 LightPixelShader(PixelInputType input) : SV_TARGET
{
    ...
    // °Å¸® °¨¼è (1 / (1 + k1*d + k2*d©÷))
    float att1 = (1.0f / (1.0f + 0.14f * dist1 + 0.01f * dist1 * dist1));
    float att2 = (1.0f / (1.0f + 0.14f * dist2 + 0.01f * dist2 * dist2));
    float att3 = (1.0f / (1.0f + 0.14f * dist3 + 0.01f * dist3 * dist3));
    float att4 = (1.0f / (1.0f + 0.14f * dist4 + 0.01f * dist4 * dist4));
