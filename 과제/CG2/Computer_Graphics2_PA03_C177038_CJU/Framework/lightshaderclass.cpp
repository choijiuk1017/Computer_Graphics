	...
	XMFLOAT4 pointDiffuse[], XMFLOAT4 pointSpecular[], XMFLOAT4 pointPosition[])
{
	...
	dataPtr4->lightPosition[0] = pointPosition[0];
	dataPtr4->lightPosition[1] = pointPosition[1];
	dataPtr4->lightPosition[2] = pointPosition[2];
	dataPtr4->lightPosition[3] = pointPosition[3];
	...
	dataPtr5->diffuseColorPoint[0] = pointDiffuse[0];
