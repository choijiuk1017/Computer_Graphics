...
FBXModelClass::FBXModelClass(const FBXModelClass& other)
{
}
...
bool FBXModelClass::Initialize(ID3D11Device* device, const WCHAR* modelFileName, const WCHAR* textureFileName)
{
	bool result;
...
int FBXModelClass::GetIndexCount()
{
	return m_indexCount;
}

ID3D11ShaderResourceView* FBXModelClass::GetTexture()
{
	return m_Texture->GetTexture();
}

bool FBXModelClass::InitializeBuffers(ID3D11Device* device)
{
...
bool FBXModelClass::LoadTexture(ID3D11Device* device, const WCHAR* filename)
{
	bool result;
...
bool FBXModelClass::LoadModel(CString filename, UINT flag)
{
...
XMMATRIX FBXModelClass::GetWorldMatrix() const
{
